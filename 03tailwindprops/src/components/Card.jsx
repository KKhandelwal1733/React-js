...
function Card({someObj,btnText="click me"}){
    ...
    <>
        ...
        <div className="glass py-4 px-5 relative -top-[3.4rem]  rounded-b-xl z-10">
          <h1 className="font-bold  font-mono  text-xl">Available soon {someObj.username}</h1>
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold ">{btnText}</button>
        </div>
      </div></>
